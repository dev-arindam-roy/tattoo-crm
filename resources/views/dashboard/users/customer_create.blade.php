...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="{{ route('customer_list') }}" class="btn btn-primary"><i class="fa fa-users" aria-hidden="true"></i> All Customers</a>
    </div>
    <div class="col-md-6">
    </div>
  </div>
  <div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form name="frm" id="frmx" action="@if(isset($user_data)){{ route('customer_update', array('user_timestamp_id' => $user_data->timestamp_id)) }}@else{{ route('customer_save') }}@endif" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-6">
