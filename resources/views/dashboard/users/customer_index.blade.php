...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <a href="{{ route('customer_create') }}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New Customer</a>
          ...
          @foreach($userList as $user)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('customer_edit', array('utid' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Edit Vendor"><i class="fa fa-2x fa-pencil-square-o base-green"></i></a>
                  
                    <a href="{{ route('customer_delete', array('utid' => $user->timestamp_id)) }}" data-toggle="tooltip" data-placement="bottom" title="Delete Vendor" onclick="return confirm('Are You Sure You Want To Delete This Customer ?');"><i class="fa fa-2x fa-trash-o base-red"></i></a>
